...
public class CubatrainingtaskTestContainer extends TestContainer {

    public CubatrainingtaskTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubatrainingtask/app.properties",
    ...
    public static class Common extends CubatrainingtaskTestContainer {

        public static final CubatrainingtaskTestContainer.Common INSTANCE = new CubatrainingtaskTestContainer.Common();
